...
include!("tests/core_lifecycle.rs");
include!("tests/search_index.rs");
include!("tests/compaction_ingest.rs");
include!("tests/read_models.rs");
include!("tests/eval_gc.rs");
include!("tests/fuzz_backup_format.rs");

...
// The lock and reader-pin names are persistent cross-version coordination keys.
// Keep them shared with older yiTrace processes opening the same data directory.
...
impl ProcessLockManager {
                ...
                Err(e) if e.kind() == io::ErrorKind::AlreadyExists => {
                    ...
                    if start.elapsed() >= self.timeout {
                        ...
                        return Err(io::Error::new(
                            ...
                            format!(
                                "timed out after {}ms waiting for Fuju Trace {name} lock at {}; another local process is using this embedded data dir. If this keeps happening, inspect owner.json or FujuTraceRuntime.health()['lock']{}",
    ...
    pub fn pin_reader(&self) -> io::Result<ProcessReaderGuard> {
        ...
        Err(io::Error::new(
            ...
            "could not allocate Fuju Trace reader pin file",
        ))
    }
